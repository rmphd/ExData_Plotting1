...
plot(Feb1_2_Power_Consump$Voltage~Feb1_2_Power_Consump$Datetime, type = "l", xlab = "datetime", ylab = "Voltage")

plot(Feb1_2_Power_Consump$Global_reactive_power~Feb1_2_Power_Consump$Datetime, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
